								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											<span>Judul</span>
											<input class="input" type="text" name="judul" id='judul' value="{{ $pertanyaan->judul }}" required ><br>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="form-group" @error('isi') has-error @enderror>
											...
											<textarea class="input" id="isiPertanyaan" name="isi" placeholder="Pertanyaan ..." autofocus>{{ $pertanyaan->isi }}</textarea>
											@error('isi')
									...
									<div class="col-md-7">
										<div class="form-group">
											<label>Tag</label>
											<input class="input" type="text" name="tag" value="{{ $pertanyaan->tag }}" required><br>
										</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span>
		...
		<script >tinymce.init({selector:'#isiPertanyaan'}); </script>
